            ...
            <div className={styles.textContainer} >
                ...
                <ul >
                    <li className={styles.link}>
                        ...
                        <a target='_blank' className={styles.link} href="mailto:pavelkazakevich040196@gmail.com">pavelkazakevich040196@gmail.com</a>
                    </li >
                    <li className={styles.link}>
                        <img src={socilalLinksIcons.vkontakte} alt="vk" />
                        <a target='_blank' className={styles.link} href="https://vk.com/kazakevich_pavel">ВКонтакте</a>
                    </li>
                    <li className={styles.link}>
                        <img src={socilalLinksIcons.telegram} alt="tg" />
                        <a target='_blank' className={styles.link} href="https://t.me/donpabloooo">+375297056356</a>
                    </li>
                    <li className={styles.link}>
